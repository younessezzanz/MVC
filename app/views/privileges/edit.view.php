                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-9">
                           <input type="text" 
                                  ...
                                  maxlength="30" 
                                  data-required="true" 
                                  value="<?= isset($privileges) ? $privileges->Privilege : ''; ?>"
                                  placeholder="<?= $text_label_privilege_title ?>">    
                        </div>
                     </div>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-9">
                           <input type="text" 
                                  ...
                                  maxlength="30" 
                                  data-required="true" 
                                  value="<?= isset($privileges) ? $privileges->PrivilegeTitle : ''; ?>"
                                  placeholder="<?= $text_label_privilege_url ?>">    
                        </div>
                     </div>
                     <div class="line line-dashed b-b line-lg pull-in"></div>
                  </div>
