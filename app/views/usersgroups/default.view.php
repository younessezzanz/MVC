   ...
   <section class="scrollable padder">
      <section class="panel panel-default section_content">
         ...
         <header class="panel-heading header_title"><?= $title_header_table ?>
            ...
            <a href="/usersgroups/create" class="btn btn-sm btn-primary">
         ...
         <div class="table-responsive box-body">
            ...
            <table id="data" class="table table-striped m-b-none">
               <thead>
                  <tr>
                     <th width="50%"><?= $title_user_username ?></th>
                     <th width="50%"><?= $title_table_action ?></th>
                  </tr>
               </thead>
               <tbody>
                <?php 
                ...
                ?>
                  <tr class="odd">
                     <td class=""><?= $usersgroup->GroupName; ?></td>

                     <td>

                      <div class="btn-group">
                          <a href="/usersgroups/edit/<?= $usersgroup->GroupId; ?>" class="btn btn-xs btn-default"><i class="fa fa-pencil"></i></a>
                          <a href="/usersgroups/delete/<?= $usersgroup->GroupId; ?>" class="btn btn-xs btn-danger" onClick="if(!confirm('<?= $text_table_control_delete_confirm ?>')) return false;"><i class="fa fa-trash"></i></a>
                      </div>
